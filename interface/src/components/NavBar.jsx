      ...
      <nav className="fixed top-0 w-full z-50 bg-white/75 backdrop-blur-xl border-b border-neutral-200/70 shadow-2xs transition-all">
        <div className="max-w-[1680px] w-full mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 h-16 flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <Link to="/" className="flex items-center gap-2.5 font-extrabold tracking-tight text-lg sm:text-xl text-neutral-950 shrink-0 group">
              <div className="w-8 h-8 rounded-xl bg-neutral-950 flex items-center justify-center p-1 shadow-sm border border-neutral-800/80 group-hover:scale-105 transition-all">
                <img
            ...
            <a
              href="https://github.com/Rushikesh-Yeole/horizon"
              target="_blank"
              rel="noreferrer"
              title="GitHub Repository"
              className="w-8 h-8 rounded-xl bg-neutral-100 hover:bg-neutral-950 text-neutral-800 hover:text-white border border-neutral-200/80 hover:border-neutral-800 shadow-2xs transition-all flex items-center justify-center group/gh shrink-0 ml-0.5"
              aria-label="Horizon GitHub Repository"
            >
              <svg
                viewBox="0 0 24 24"
                className="w-5 h-5 fill-current transition-transform group-hover/gh:scale-105"
                aria-hidden="true"
              >
                <path
                  fillRule="evenodd"
