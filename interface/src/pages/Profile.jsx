...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-white pt-28 pb-20 px-6 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-neutral-200/80 mb-10">
        ...
        <button
          ...
          className="px-6 py-2.5 rounded-full bg-neutral-950 text-white font-semibold text-xs hover:bg-neutral-800 transition-all shadow-sm disabled:opacity-50 flex items-center justify-center gap-2 self-start md:self-auto"
        >
      ...
      <div className="space-y-8">
        ...
        <div className="bg-neutral-50/50 rounded-3xl p-7 border border-neutral-200/80 shadow-2xs">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-mono text-neutral-500 font-semibold">{skills.length} Active Skills</span>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex gap-2">
              ...
              <button
                onClick={() => addSkill()}
                className="px-4 py-2.5 rounded-xl bg-neutral-950 text-white font-semibold text-xs hover:bg-neutral-800 transition-all flex items-center gap-1.5 shrink-0"
              >
                <Plus size={14} />
                Add Skill
              </button>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 font-mono">Degrees, universities, and formal training</p>
              </div>
            </div>
            <button 
              onClick={() => setEducation([...education, { degree: '', branch: '', college: '' }])}
              className="px-3 py-1.5 rounded-lg border border-neutral-200 bg-white text-xs font-semibold hover:border-neutral-950 transition-all flex items-center gap-1"
            >
              <Plus size={14} /> Add
            </button>
          </div>
              ...
              education.map((edu, idx) => (
                <div key={idx} className="p-4 rounded-2xl bg-white border border-neutral-200 relative group">
                  <button 
                    ...
                    className="absolute top-4 right-4 text-neutral-400 hover:text-rose-500 transition-colors opacity-0 group-hover:opacity-100"
                  >
                    <X size={16} />
                  </button>
        ...
        <div className="bg-neutral-50/50 rounded-3xl p-7 border border-neutral-200/80 shadow-2xs">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-base font-extrabold text-neutral-950 tracking-tight">Projects</h3>
                <p className="text-xs text-neutral-500 font-mono">Key artifacts and production proof</p>
              </div>
            </div>
            <button 
